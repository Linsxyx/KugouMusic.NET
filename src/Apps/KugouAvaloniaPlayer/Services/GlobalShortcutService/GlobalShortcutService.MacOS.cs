...
public sealed partial class GlobalShortcutService
{
    ...
    private static uint? ToMacVirtualKey(Avalonia.Input.Key key)
    {
        return key switch
        {
            ...
            Avalonia.Input.Key.F1 => 122,
            Avalonia.Input.Key.F2 => 120,
            Avalonia.Input.Key.F3 => 99,
            Avalonia.Input.Key.F4 => 118,
            Avalonia.Input.Key.F5 => 96,
            Avalonia.Input.Key.F6 => 97,
            Avalonia.Input.Key.F7 => 98,
            Avalonia.Input.Key.F8 => 100,
            Avalonia.Input.Key.F9 => 101,
            Avalonia.Input.Key.F10 => 109,
            Avalonia.Input.Key.F11 => 103,
            Avalonia.Input.Key.F12 => 111,
