...
[JsonSerializable(typeof(AudioImageResponse))]
[JsonSerializable(typeof(List<List<AudioImageAuthor>>))]
[JsonSerializable(typeof(List<AudioImageAuthor>))]
[JsonSerializable(typeof(Dictionary<string, List<AudioImageItem>>))]
[JsonSerializable(typeof(List<AudioImageItem>))]
