...
internal static partial class AndroidJniBootstrap
{
    ...
    [LibraryImport("KuGou.Android.JniBootstrap", EntryPoint = "KugouAndroidRegisterNatives")]
    private static partial int RegisterAndroidCryptoNatives(IntPtr javaVm);
    ...
    {
        var version = InitializeAndroidCrypto(javaVm, reserved);
        return RegisterAndroidCryptoNatives(javaVm) == 0 ? version : -1;
    }
}
#endif
